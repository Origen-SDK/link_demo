require 'origen'
class LinkDemoApplication < Origen::Application
  ...
  self.name       = "link_demo"
  self.namespace  = "LinkDemo"
  config.name     = "link_demo"
  config.initials = "LinkDemo"
  # Change this to point to the revision control repository for this application
  #config.rc_url   = "ssh://git@sw-stash.mycompany.net/myproject/link_demo.git"
